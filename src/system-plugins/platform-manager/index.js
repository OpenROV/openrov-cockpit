...
function PlatformManager(name, deps) {
  ...
  }).then(LoadCPUInterface).then(LoadBoardInterface).then(function (platform) {
...
function LoadCPUInterface(platform) {
  ...
  return CPUInterfaceLoader.Compose(platform).catch(function (err) {
...
function LoadBoardInterface(platform) {
  ...
  return BoardInterfaceLoader.Compose(platform).catch(function (err) {
