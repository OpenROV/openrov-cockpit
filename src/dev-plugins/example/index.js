function example(name, deps) {
  ...
  //instance variables
  this.deps = deps;
  //hold a reference to the plugin dependencies if you are going to use them
  this.globalEventLoop = deps.globalEventLoop;
  //explicitlly calling out the rov eventemitter
...
example.prototype.start = function start() {
  var self = this;
  //set closure state variable for use in functions
