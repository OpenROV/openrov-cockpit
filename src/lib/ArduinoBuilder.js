...
ArduinoBuilder.prototype.BuildSketch = function (options, onStdout, onStderr) {
  ...
  return Promise.try(function () {
    ...
    return fs.removeAsync(stagedSketchDir).then(function () {
    ...
    return Promise.map(pluginDirs, function (pluginName) {
      ...
      return fs.statAsync(path.join(pluginDir, 'firmware')).then(function () {
    ...
    if (options.cleanAfterBuild) {
      // Clean up temp dir
      return fs.removeAsync(options.buildDir).then(function () {
