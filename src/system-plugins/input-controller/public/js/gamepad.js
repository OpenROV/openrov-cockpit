    ...
    if (control.bindings.gamepad !== undefined) {
      ...
      if (gpKey !== undefined) {
        ...
        if (control.down !== undefined)
          self.gp.assignment[gpKey].BUTTON_DOWN = control.down;
        if (control.up !== undefined)
          self.gp.assignment[gpKey].BUTTON_UP = control.up;
        if (control.axis !== undefined)
          self.gp.assignment[gpKey].AXIS_CHANGED = control.axis;
          ...
          control.secondary.forEach(function (secondary) {
            if (secondary.bindings.gamepad !== undefined) {
              ...
              if (secondary.down !== undefined)
                self.gp.assignment[subKey].BUTTON_DOWN = secondary.down;
              if (secondary.up !== undefined)
                self.gp.assignment[subKey].BUTTON_UP = secondary.up;
              if (secondary.axis !== undefined)
                self.gp.assignment[subKey].AXIS_CHANGED = secondary.axis;
            }
          });
        }
      }
