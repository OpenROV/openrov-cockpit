...
cp bin/openrov-trident-rev10/trident.hex /opt/openrov/firmware/deploy/trident-rev10-samd.bin
cp bin/openrov-trident-rev10/trident.elf /opt/openrov/firmware/deploy/trident-rev10-samd.elf